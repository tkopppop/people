...
- spender (brad)<br>
  - france linux kernel developer (grsecurity.net)<br>
    ...
    (6 years write linux kernel exploits and released in isec.pl as a researcher director)
...
- twiz<br>
  - best issued phrack.com article's co-owner and amazon book author<br>
    (i help to edit 4 months his articles to amazon pdf ebook("Attacking the core") and registered on amazon then lastly,<br>
    they(twiz&sgrakkyu) made paperback too)
